...
//			 * 2. Read numToCheck characters from the file into a String
            String textToCheck = getStringFromFile("data/warAndPeace.txt", numToCheck);
//			 *     Hint: use the helper method below.
//			 * 3. Time a loop that runs trials times (trials is the variable above) that:
            long startTime = System.nanoTime();
            BasicDocument bd = new BasicDocument(textToCheck);
...
//			 * 5. Time a loop that runs trials times (trials is the variable above) that:
            ...
            EfficientDocument ed = new EfficientDocument(textToCheck);
            double fleshScore2 = ed.getFleschScore();
            long endTime2 = System.nanoTime();
//			 *     a. Creates an EfficientDocument
//			 *     b. Calls fleshScore on this document
//			 * 6. Print out the time it took to complete the loop in step 5
            System.out.print((endTime2 - startTime2)  + "\n");
